...
export const AnimatedTooltip = ({
  ...
  return (
    <div className={`group flex flex-row ${className}`}>
      {items.map((item, idx) => (
        <div
        ...
        >
          ...
          <div
            ...
            className="relative !m-0 h-14 w-14 rounded-full border-2 border-white object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105 flex items-center justify-center"
          >
